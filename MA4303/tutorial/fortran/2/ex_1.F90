...
CONTAINS
   ...
   IMPLICIT NONE
      TYPE(MATRIX_DENSE), INTENT(INOUT) :: self
   ...
   IMPLICIT NONE
      TYPE(MATRIX_DENSE), INTENT(IN) :: self
   ...
   IMPLICIT NONE
      TYPE(MATRIX_CSR), INTENT(INOUT) :: self
   ...
   IMPLICIT NONE
      TYPE(MATRIX_CSR), INTENT(IN) :: self
      REAL(KIND=8), DIMENSION(:), INTENT(IN)      :: x 
      REAL(KIND=8), DIMENSION(:), INTENT(INOUT)   :: y
      ! LOCAL
      INTEGER :: i
   ...
   IMPLICIT NONE
      ...
      SELECT TYPE(self)
      CLASS IS (MATRIX_DENSE)
         CALL MATRIX_PRODUCT_VECTOR_DENSE(self, x, y)
      CLASS IS (MATRIX_CSR)
         CALL MATRIX_PRODUCT_VECTOR_CSR(self, x, y)
      CLASS DEFAULT
         PRINT *, "MATRIX_PRODUCT_VECTOR: unexpected type for self object!"
      END SELECT
   ...
   IMPLICIT NONE
      ...
      SELECT TYPE (self)
      CLASS IS (MATRIX_DENSE)
         CALL MATRIX_FREE_DENSE(self) 
      CLASS IS (MATRIX_CSR)
         CALL MATRIX_FREE_CSR(self) 
      CLASS DEFAULT
         STOP 'MATRIX_FREE: unexpected type for self object!'
      END SELECT
